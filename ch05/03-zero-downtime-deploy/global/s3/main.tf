...
resource "aws_s3_bucket_public_access_block" "public_access" {
  bucket = aws_s3_bucket.terraform_state.id
  // Prevent creation and updates of public ACLs for both objects and bucket
  block_public_acls = true
  // Prevents creation and updates of bucket policies granting public access
  block_public_policy = true
  // Ignores public ACLs if they alredy exist or are somehow added in the future
